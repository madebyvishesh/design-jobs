...
const ASHBY_COMPANIES: Array<{ slug: string; name: string; domain: string; batch?: string }> = [
  ...
  // Verified-live expansion (AI infra, dev tools, design)
  { slug: 'baseten', name: 'Baseten', domain: 'baseten.co' },
  { slug: 'bunny', name: 'Bunny.net', domain: 'bunny.net' },
  { slug: 'bynder', name: 'Bynder', domain: 'bynder.com' },
  { slug: 'cerebras', name: 'Cerebras', domain: 'cerebras.net' },
  { slug: 'circleback', name: 'Circleback', domain: 'circleback.ai' },
  { slug: 'crusoe', name: 'Crusoe', domain: 'crusoe.ai' },
  { slug: 'decagon', name: 'Decagon', domain: 'decagon.ai' },
  { slug: 'deepgram', name: 'Deepgram', domain: 'deepgram.com' },
  { slug: 'encord', name: 'Encord', domain: 'encord.com' },
  { slug: 'etched', name: 'Etched', domain: 'etched.com' },
  { slug: 'frontify', name: 'Frontify', domain: 'frontify.com' },
  { slug: 'influxdata', name: 'InfluxData', domain: 'influxdata.com' },
  { slug: 'knock', name: 'Knock', domain: 'knock.app' },
  { slug: 'lancedb', name: 'LanceDB', domain: 'lancedb.com' },
  { slug: 'lightning', name: 'Lightning AI', domain: 'lightning.ai' },
  { slug: 'modal', name: 'Modal', domain: 'modal.com' },
  { slug: 'mux', name: 'Mux', domain: 'mux.com' },
  { slug: 'neptune', name: 'Neptune', domain: 'neptune.ai' },
  { slug: 'prefect', name: 'Prefect', domain: 'prefect.io' },
  { slug: 'rain', name: 'Rain', domain: 'rain.com' },
  { slug: 'redis', name: 'Redis', domain: 'redis.com' },
  { slug: 'roboflow', name: 'Roboflow', domain: 'roboflow.com' },
  { slug: 'runpod', name: 'RunPod', domain: 'runpod.io' },
  { slug: 'sierra', name: 'Sierra', domain: 'sierra.ai' },
  { slug: 'svix', name: 'Svix', domain: 'svix.com' },
  { slug: 'temporal', name: 'Temporal', domain: 'temporal.io' },
  { slug: 'ultralytics', name: 'Ultralytics', domain: 'ultralytics.com' },
  { slug: 'vultr', name: 'Vultr', domain: 'vultr.com' },
  { slug: 'zapier', name: 'Zapier', domain: 'zapier.com' },
  // Reputable expansion — SaaS, dev tools, education, marketplaces (verified live)
  { slug: 'abound', name: 'Abound', domain: 'abound.com' },
  { slug: 'anima', name: 'Anima', domain: 'animaapp.com' },
  { slug: 'ankorstore', name: 'Ankorstore', domain: 'ankorstore.com' },
  { slug: 'apify', name: 'Apify', domain: 'apify.com' },
  { slug: 'aptible', name: 'Aptible', domain: 'aptible.com' },
  { slug: 'arcade', name: 'Arcade', domain: 'arcade.software' },
  { slug: 'astronomer', name: 'Astronomer', domain: 'astronomer.io' },
  { slug: 'axiom', name: 'Axiom', domain: 'axiom.co' },
  { slug: 'babbel', name: 'Babbel', domain: 'babbel.com' },
  { slug: 'brainly', name: 'Brainly', domain: 'brainly.com' },
  { slug: 'cambly', name: 'Cambly', domain: 'cambly.com' },
  { slug: 'character', name: 'Character.AI', domain: 'character.ai' },
  { slug: 'checkly', name: 'Checkly', domain: 'checklyhq.com' },
  { slug: 'circle', name: 'Circle', domain: 'circle.com' },
  { slug: 'conductor', name: 'Conductor', domain: 'conductor.com' },
  { slug: 'constructor', name: 'Constructor', domain: 'constructor.io' },
  { slug: 'expensify', name: 'Expensify', domain: 'expensify.com' },
  { slug: 'fig', name: 'Fig', domain: 'fig.io' },
  { slug: 'gitbook', name: 'GitBook', domain: 'gitbook.com' },
  { slug: 'handshake', name: 'Handshake', domain: 'joinhandshake.com' },
  { slug: 'hostinger', name: 'Hostinger', domain: 'hostinger.com' },
  { slug: 'incident', name: 'incident.io', domain: 'incident.io' },
  { slug: 'joor', name: 'JOOR', domain: 'joor.com' },
  { slug: 'kestra', name: 'Kestra', domain: 'kestra.io' },
  { slug: 'lago', name: 'Lago', domain: 'getlago.com' },
  { slug: 'lightspeed', name: 'Lightspeed', domain: 'lightspeedhq.com' },
  { slug: 'literati', name: 'Literati', domain: 'literati.com' },
  { slug: 'lovable', name: 'Lovable', domain: 'lovable.dev' },
  { slug: 'materialize', name: 'Materialize', domain: 'materialize.com' },
  { slug: 'maven', name: 'Maven', domain: 'maven.com' },
  { slug: 'moss', name: 'Moss', domain: 'getmoss.com' },
  { slug: 'n8n', name: 'n8n', domain: 'n8n.io' },
  { slug: 'orb', name: 'Orb', domain: 'withorb.com' },
  { slug: 'orca', name: 'Orca Security', domain: 'orca.security' },
  { slug: 'outschool', name: 'Outschool', domain: 'outschool.com' },
  { slug: 'paddle', name: 'Paddle', domain: 'paddle.com' },
  { slug: 'pleo', name: 'Pleo', domain: 'pleo.io' },
  { slug: 'preply', name: 'Preply', domain: 'preply.com' },
  { slug: 'quora', name: 'Quora', domain: 'quora.com' },
  { slug: 'reprise', name: 'Reprise', domain: 'reprise.com' },
  { slug: 'scribe', name: 'Scribe', domain: 'scribehow.com' },
  { slug: 'signoz', name: 'SigNoz', domain: 'signoz.io' },
  { slug: 'stream', name: 'Stream', domain: 'getstream.io' },
  { slug: 'tango', name: 'Tango', domain: 'tango.us' },
  { slug: 'thinkific', name: 'Thinkific', domain: 'thinkific.com' },
  { slug: 'tonal', name: 'Tonal', domain: 'tonal.com' },
  { slug: 'turbopuffer', name: 'turbopuffer', domain: 'turbopuffer.com' },
  { slug: 'windmill', name: 'Windmill', domain: 'windmill.dev' },
  // Reputable expansion — fintech & crypto (verified live)
  { slug: 'ledger', name: 'Ledger', domain: 'ledger.com' },
  { slug: 'magiceden', name: 'Magic Eden', domain: 'magiceden.io' },
  ...
  { slug: 'quicknode', name: 'QuickNode', domain: 'quicknode.com' },
  { slug: 'safe', name: 'Safe', domain: 'safe.global' },
  { slug: 'sardine', name: 'Sardine', domain: 'sardine.ai' },
  { slug: 'sentilink', name: 'SentiLink', domain: 'sentilink.com' },
  { slug: 'socure', name: 'Socure', domain: 'socure.com' },
  { slug: 'teya', name: 'Teya', domain: 'teya.com' },
  { slug: 'turnkey', name: 'Turnkey', domain: 'turnkey.com' },
